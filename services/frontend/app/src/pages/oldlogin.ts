...
<section class="grid grid-cols-4 gap-11">
	...
	<div class="col-span-1 flex flex-col items-start">
		...
		<form id="login_form" data_form="login" class="flex flex-col gap-2">
...
// liste des events de la page de login
const LOGIN_PAGE_HANDLERS = ['submit:register', 'submit:login', 'click:login_google']
