...
<section class="grid grid-cols-4 gap-11">
	...
	<div class="col-span-1 flex flex-col items-start">
		<div class="news_paragraph">
			<p class="text-sm py-6">Ipsum dolore veritatis odio in ipsa corrupti aliquam qui commodi. Eveniet possimus voluptas voluptatem.</p>
		</div>
		<img src="/assets/images/image_9.png" alt="AHHHHH !" class="w-full object-cover opacity-50 select-none">
	...
	<div class="col-span-1 flex flex-col items-start">
		...
		<div class="news_paragraph">
			<p class="text-sm py-2">Ipsum dolore veritatis odio in ipsa corrupti aliquam qui commodi. Eveniet possimus voluptas voluptatem. Consectetur minus maiores qui. Eos debitis officia. Nam perferendis facilis asperiores ea qui voluptates dolor eveniet.</p>
		</div>
	</div>
</section>
`