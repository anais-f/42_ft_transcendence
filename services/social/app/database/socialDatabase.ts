...
db.exec('CREATE TABLE IF NOT EXISTS relations ( user_id INTEGER, friend_id INTEGER, relation_status INTEGER, origid_id INTEGER, PRIMARY KEY (id_user, friend_id) )')
